...
from mcrpy.optimizers.SPOptimizer3D import SPOptimizer3D
from mcrpy.src import optimizer_factory


class LBFGSB_3D_Bounds(SPOptimizer3D):
    def __init__(self,
                 max_iter: int = 100,
...
def register() -> None:
    optimizer_factory.register("LBFGSB_3D_Bounds", LBFGSB_3D_Bounds)
