...
from mcrpy.optimizers.SPOptimizer2D import SPOptimizer2D
from mcrpy.src import optimizer_factory


class LBFGSB_2D_Bounds(SPOptimizer2D):
    def __init__(self,
                 max_iter: int = 100,
...
def register() -> None:
    optimizer_factory.register("LBFGSB_2D_Bounds", LBFGSB_2D_Bounds)
